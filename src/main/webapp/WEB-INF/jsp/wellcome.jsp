...
|___|___|  /\___  /    \__/\  /  \___  >___  /  |___| /____/  
	...
	<kbd>${os}
		${hostname} ${version} ${time} <br> Last login: ${last_time} from
		${last_ip}<br> Do you wanna know if you would survive thanos
		snap?? ->> <a href="./thanos">CLICK HERE</a><br> <br>
		user@${hostname}:~$ ${message}
	</kbd>
